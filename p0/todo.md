...
1. [ ] Change Navigation menu 
    - Home
    - Topics (dropdown)
        - Shaders (will have its own series of content pages)
        - Godot (will have its own series of content pages)
        - three.js (will have its own series of content pages)
    - About me
2. [ ] Duplicate existing content page for topic subpages (see above)
3. [ ] Change footer to be inline with navigation. Instead of dropdown create static list.
...
1. [ ] Update Name of Site
2. [ ] Update Branding in Navigation
3. [ ] Update Branding/Template in Footer
4. [ ] Fix headers to create a flow for my own personal test site and sections about code that I am learning i.e. shaders
5. [ ] All images need to change to be relevant.
6. [ ] On homepage, update What we do to talk about the reason I am making the site.
7. [ ] On homepage, change article preview sections to match with main topics that also follow navigation links.
